namespace TDFramework
{
    ...
    public class LoadingScene : MonoBehaviour
    {
        ...
        {
            if (GlobalHelper.SceneInfoMgr.NextSceneInfo != null)
            {
                LoadSceneBySceneId();
            }
        }
        ...
        {
            op = SceneManager.LoadSceneAsync(GlobalHelper.SceneInfoMgr.NextSceneInfo.Index);
        ...
        {
            op = SceneManager.LoadSceneAsync(GlobalHelper.SceneInfoMgr.NextSceneInfo.Name);
            op.allowSceneActivation = false;
            StartCoroutine(ProcessLoad());
        }
